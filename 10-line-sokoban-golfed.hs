...
main=g.o((,)<*>id<$>words).lines$x%y%z%b;r=reverse;(%)=(<>);p=putStrLn;k="λ."
j=mapM p;e=[]:e;g[]=p"You win!";g l|(s,_):v<-l,all('_'`notElem`)s=j s*>p""*>g v
g(w@(s,u):v)=j s*>(q<$>getLine>>=(\i->g$(i?([id,t,t.r,id,o r]!!i)$w,u):v));o=map
...
"_"#('o':r)='O':r%k;x#l=x%l%"λ";t=foldr(zipWith(:))e;q(c:_)=fromEnum c`mod`5
-- ^ 10 ----------------------------------------------------------------------80
