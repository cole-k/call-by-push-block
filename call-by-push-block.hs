...
e('λ':c)|(a,b)<-span(>'n')c=u(u a#m 1 b)%e(y b);e(c:d)=c:e d;e l=l;e&0=u.t;f&_=f
x%y=x<>y;p=putStr;a=length;w n="_+\n.o λ#"!!mod n 8:w(n`div`8);d=getLine;z=m 1.u
r=map;1?f=z;4?f=h[];5?f=y%z%z;i?f=(h.(f&i).r e.f.head)%id;v(x:_)=c x`mod`7;v _=0
t=foldr(zipWith(:))s;main=print=<<(mapM g.zip[1..].r(h.words).lines$m 5.w.c=<<x)
l=print;g(l,o)|o==[]=h 0|any(elem '_')$o!!0=do{l!o;p"λ:wasd 🔄:x 🔙:u\n";i<-v<$>d;
g(l,i?([t.u,t,id,t,t,t,r u]!!i)$o)}|0<3=a o<$l!o<*p"↩"<*d;k="λ.";y=drop 1;m=take
n!x@(s:_)=p"\^[cLvl "*>l n*>l(a x)*>p(unlines s);c=fromEnum;[]#""=".";l#""=y l%k
n#"."=n%k;[]#"+"="..";l#"+"='.':y l%k;('o':r)#"_"='O':r%k;l#x=x%l%"λ";h x=pure x
s=[]:s;u=reverse;x=n%"䷯ቤ稉翿矻㛝㻛㽛盳⛳ۛ四მ四ᇛ四Ά埿䤻徤漻埧缻埧䤷埜翻執㛛⛻˛囙ᛋ噛㛛四租廼㞛図㻻域̟廡㛟⻛㟿㛛㷫㣃竜㻷㟿泽矟杘㞛⛛"
-- ^10 ------------------------------------------------------------------ 80> --
